...
const Jokes = ({ question, punchLine, author }) => {
  //   let question;
  //   if (props.joke.question) {
  //     question = <li>{props.joke.question}</li>;
  //   } else {
  ...
  return (
    <div>
      ...
      <ul>
        <li> {punchLine ? punchLine : "No punchline"}</li>
        <li> Who made this? {author ? author : "no mans made this"}</li>
      </ul>
      <hr></hr>
    </div>
  );
